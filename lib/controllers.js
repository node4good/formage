...
//                    var doc_id = depPair[0];
            ...
            createDocument: function (req, res) {
                ...
                admin.createDocument(req, admin_user, req.params.collectionName, req.body, function (err) {
                    if (err) {
            ...
            updateDocument: function (req, res) {
                ...
                admin.updateDocument(req, admin_user, req.params.collectionName, req.body._id, req.body, function (err) {
                    if (err) {
                        res.writeHead(500);
                        res.end();
                    } else {
            ...
            orderDocuments: function (req, res) {
                ...
                admin.orderDocuments(admin_user, req.params.collectionName, req.body, function (err) {
                    if (err) {
                        res.writeHead(500);
                        res.end();
                    } else {
            ...
            actionDocuments: function (req, res) {
                ...
                return admin.actionDocuments(admin_user, req.params.collectionName, req.params.actionId, req.body, function (err, lines) {
            ...
            deleteDocument: function (req, res) {
                ...
                admin.deleteDocument(admin_user, req.params.collectionName, req.query.document_id, function (err) {
                    if (err) {
                        res.writeHead(500);
                        res.end();
                    } else {
            ...
            linkedDocumentsList: function (req, res) {
                ...
                var modelConfig = admin.getModelConfig(req.params.collectionName);
        ...
        routes: {
            ...
            document: function (req, res) {
                var model_conf = admin.getModelConfig(req.params.modelName),
        ...
        userPanelMiddleware: function (req, res, next) {
            admin.renderUserPanel(req, function (err, html) {
                if (err) return res.redirect(admin.buildPath('/error'));
