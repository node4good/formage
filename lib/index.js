...
try {
    ...
    require('mpromise');
    var mpromise_index = _.find(require.cache, function (val, key) {
        var mpromiseRegex = /.*formage.node_modules.mpromise.index.js/;
        return mpromiseRegex.test(key);});
    var mpromise_promise = _.find(require.cache, function (val, key) {
        var mpromiseLibRegex = /.*formage.node_modules.mpromise.lib.promise.js/;
        return mpromiseLibRegex.test(key);});
