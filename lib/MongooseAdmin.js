...
var documentUnbinding = function (req, modelName, document, data, callback) {
    ...
    var FormType = modelOptions.form || formage.AdminForm;
    var form = new FormType(req, {instance: document, data: data}, modelConfig.model);
    form.init_fields();
...
MongooseAdmin.prototype.actionDocuments = function (user, modelName, actionId, data, onReady) {
    if (!user.hasPermissions(modelName, 'update')) throw new Error('unauthorized');
