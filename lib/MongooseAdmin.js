...
var MongooseAdmin = module.exports = function (app, options) {
    ...
    if (this.options.root[0] !== '/') this.options.root = '/' + this.options.root;
...
MongooseAdmin.prototype.getAccesibleModels = function (user, callback) {
...
MongooseAdmin.prototype.createDocument = function (req, collectionName, params, onReady) {
    var self = this;
    var model = this.models[collectionName].model;
    //noinspection LocalVariableNamingConventionJS
    var FormType = this.models[collectionName].options.form || formage.AdminForm;
    if (!req.admin_user.hasPermissions(collectionName, 'create')) return onReady('unauthorizaed');
...
MongooseAdmin.prototype.updateDocument = function (req, collectionName, documentId, params, onReady) {
    var self = this,
        model = this.models[collectionName].model;

    if (!req.admin_user.hasPermissions(collectionName, 'update')) return onReady('unauthorized');
    var FormType2 = this.models[collectionName].options.form || formage.AdminForm;
...
MongooseAdmin.prototype.login = function (username, password, onReady) {
    this.Users.getByUsernamePassword(username, password, function (err, adminUser) {
