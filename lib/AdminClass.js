...
AdminClass.prototype.postRegistrationInit = function () {
...
AdminClass.prototype.updateDocument = function (req, modelName, documentId, data, callback) {
    ...
    this.models[modelName].model.findById(documentId, function (err, document) {
        if (err) throw err;
        self.documentUnbinding(req, modelName, document, data, callback);
    }.bind(this));
};
    ...
    process.nextTick(function () {
        filters.forEach(function (filter) {
            ...
            model.collection.distinct(filter, function (err, results) {
                ...
                formage.getModel(options.ref).find().where('_id').in(results).exec(function (err, refs) {
                    if (!refs) return;
                    output.push({
                        key: filter,
                        isString: false,
