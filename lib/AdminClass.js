 ...
 * @constructor
 */
function AdminClass(adapter, options) {
    this.models = {};
...
AdminClass.prototype.registerModel = function (model, modelName, opt_options) {
    ...
    var list_populate = [];
    var paths = this.adapter.getPaths(model);
...
AdminClass.prototype.postRegistrationInit = function () {
    ...
    _.forEach(this.models, function(modelConfig, modelName) {
        this.adapter.registerModelPermissions(modelName);
...
AdminClass.prototype.ensureUserExists = function (username, password) {
    this.adapter.ensureExists(username, password, function (err, adminUser) {
        if (!err)
...
AdminClass.prototype.login = function (username, password, callback) {
    this.adapter.getByUsernamePassword(username, password, callback);
};

AdminClass.prototype.registerAdminUserModel = function (name, options) {
    this.registerModel(this.adapter.Users, name || 'Admin Users', _.extend({
