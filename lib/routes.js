...
module.exports = function (express, rootApp, registry) {
    ...
    app.post('/model/:modelName/document/:documentId', [express.bodyParser(), controllers.authMiddleware(), controllers.singleMiddleware], controllers.routes.documentPost);
    // JSON routes
    app.post('/json/model/:modelName/document/:documentId', [express.bodyParser(), controllers.authMiddleware()], controllers.json_routes.upsertDocument);
    app.get('/json/model/:modelName/document/:documentId/dependencies', controllers.json_routes.checkDependencies);
    app.delete('/json/model/:modelName/document/:documentId', controllers.authMiddleware(), controllers.json_routes.deleteDocument);
    ...
    rootApp.use(registry.options.root, app);
