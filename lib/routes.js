...
module.exports = function (express, controllers, rootApp, rootPath, version) {
    ...
    app.post('/json/model/:collectionName/document', controllers.authMiddleware(), controllers.json_routes.createDocument);
    app.put('/json/model/:collectionName/document', controllers.authMiddleware(), controllers.json_routes.updateDocument);
    ...
    app.delete('/json/model/:collectionName/document', controllers.authMiddleware(), controllers.json_routes.deleteDocument);
