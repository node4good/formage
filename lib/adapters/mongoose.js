...
module.exports = function (mongoose) {
    ...
    module.exports.getAdminUser = function getAdminUser(sessionStore) {
        var Model = module.exports.UsersModel;
        if (!Model) return MPromise.fulfilled(false);
        return Model.fromSessionStore(sessionStore);
    };
