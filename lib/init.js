...
module.exports = function(rootApp, express, models, options) {
    ...
    var admin = new MongooseAdmin(rootApp, options);
    admin.app = registerRoutes(rootApp, express, admin.root, module.exports.version, require('./controllers')(admin));
    admin.setAdminTitle(options.title || rootApp.get('site') + ' Admin');
