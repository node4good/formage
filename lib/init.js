...
var path = require('path'),
    ...
    AdminClass = require('./AdminClass.js'),
...
module.exports = function (rootApp, express, models, adapter, options) {
    ...
    var admin = new AdminClass(adapter, options);
    registerRoutes(express, rootApp, admin);
    ...
    if (options.admin_users_gui) {
        admin.registerModel(adapter.Users, 'Admin_Users', _.extend({
