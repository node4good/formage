...
var BaseField = exports.BaseField = Class.extend({
    ...
    pre_render: function (callback) {
        ...
        this.clean_value({body: {}, files: {}}, function () {
...
exports.NumberField = exports.IntegerField = StringField.extend({
    init: function (options) {
...
var FilepickerField = exports.FilepickerField = BaseField.extend({
    init: function (options) {
        options.FILEPICKER_API_KEY = options.FILEPICKER_API_KEY ||  process.env.FILEPICKER_API_KEY;
        options.AVIARY_API_KEY = options.AVIARY_API_KEY ||  process.env.AVIARY_API_KEY;
        options.widget = options.widget || Widgets.FilepickerWidget;
        this._super(options);
        if (this.options.FILEPICKER_API_KEY && this.options.AVIARY_API_KEY) {
            this.header_lines = [
                '<script>var FILEPICKER_API_KEY="' + this.options.FILEPICKER_API_KEY + '", AVIARY_API_KEY="' + this.options.AVIARY_API_KEY + '";</script>',
...
var PictureField = exports.PictureField = BaseField.extend({
    ...
    clean_value: function (req, callback) {
        ...
        if (this.value && this.value.url && req.body[this.name + '_clear']) {
            this.value = null;
        }
...
var GeoPointField = exports.GeoPointField = BaseField.extend({
    ...
    clean_value: function (req, callback) {
        var str = this.value || '';
        if (!_.isString(str)) return this._super(req, callback);
        var parts = str.split(',');
