...
AdminForm.prototype.handle = function (options) {
...
AdminForm.prototype.save = function (callback) {
    this.init_fields();
...
AdminForm.prototype.is_valid = function (callback) {
    this.init_fields();
...
AdminForm.prototype.actual_save = function (callback) {
    var self = this;
    Object.keys(self.clean_values).forEach(function (field_name) {
        self.instance[field_name] = self.clean_values[field_name];
    });
