...
buf.push("<!DOCTYPE html>\n<html lang=\"en\">\n  <head>\n    <meta charset=\"utf-8\">\n    <title>" + (null == (jade.interp = pageTitle) ? "" : jade.interp) + "</title>\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/css/ui-lightness/jquery-ui-1.10.2.custom.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/bootstrap/css/bootstrap.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/css/main.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/css/forms.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/datepicker/datepicker.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/timepicker/timepicker.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/vendor/bootstrap-datetimepicker.min.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/css/maps.css') }, {"rel":true,"href":true})) + ">\n    <link" + (jade.attrs({ terse: true, 'rel':('stylesheet'), 'href':('' + (rootPath) + '/select2/select2.css') }, {"rel":true,"href":true})) + ">\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/js/lib/jquery-1.9.1.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/js/lib/jquery-ui-1.10.2.custom.min.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/bootstrap/js/bootstrap.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/timepicker/bootstrap-timepicker.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/vendor/bootstrap-datetimepicker.min.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/ckeditor/ckeditor.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/datepicker/bootstrap-datepicker.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/select2/select2.js') }, {"src":true})) + "></script>\n    <script>var root = '" + (jade.escape((jade.interp = rootPath) == null ? '' : jade.interp)) + "';</script>" + (null == (jade.interp = renderedHead) ? "" : jade.interp) + "" + (((jade.interp = global_head) == null ? '' : jade.interp)) + "\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/js/fpav.js') }, {"src":true})) + "></script>\n    <script" + (jade.attrs({ terse: true, 'src':('' + (rootPath) + '/js/maps.js') }, {"src":true})) + "></script>\n  </head>\n  <body>");
if (!dialog)
{
...
buf.push("\n                  <th class=\"table-header-repeat line-left minwidth-1 center\"><a href=\"#{field.href)}\">" + (jade.escape((jade.interp = field.label) == null ? '' : jade.interp)) + "</a></th>");
    }
...
if (filter.isString)
{
buf.push("\n                <div>\n                  <input" + (jade.attrs({ terse: true, 'type':('text'), 'style':('width:217px; !important '), 'name':('' + (filter.key) + ''), 'value':('' + (current_filters[filter.key] || "") + '') }, {"type":true,"style":true,"name":true,"value":true})) + ">\n                  <button" + (jade.attrs({ terse: true, 'data-href':('' + (makeLink(filter.key, "__replace__")) + ''), "class": [('free_search')] }, {"data-href":true})) + ">search</button>\n                </div>");
}
    }
