...
var catch_all_middleware = function catch_all_middleware(err, req, res, next) {
...
var domain_wrapper_middleware = function domain_wrapper_middleware(req, res, next) {
    var d = domain.create();
    d.add(req);
    d.add(res);
...
var register_process_catcher = function register_process_catcher() {
