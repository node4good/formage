    ...
    before(function (done) {
        ...
        mongoose.connect(conn_str, function (err) {
            ...
            return mongoose.connection.db.dropDatabase(function (err) {
                ...
                var app = express();
                formage.init(app, express, {pages: pages, AppliesTo: AppliesTo, Tests: tests, config: config, gallery: gallery, embed:embed}, {
